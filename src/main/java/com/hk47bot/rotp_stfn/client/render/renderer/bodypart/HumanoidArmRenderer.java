...
public class HumanoidArmRenderer extends SimpleEntityRenderer<UnzippedArmEntity, PlayerArmModel> {
    ...
    @Override
    protected void doRender(UnzippedArmEntity entity, PlayerArmModel model, float partialTick, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
